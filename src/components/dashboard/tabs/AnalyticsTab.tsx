...
import { BarChart3, FileText, Sparkles, Trash2 } from "lucide-react";
    ...
    <>
      ...
      <div className="grid-2">
        ...
        <Panel title="Saved answers from Athena">
          {!configured ? (
            <div className="live-empty">
              Saved answers are only available on a real account — sign in for real to save answers from Athena in
              the corner.
            </div>
          ) : reportsLoading ? (
            <div className="live-empty">Loading…</div>
